...
### ⚠️ YouTube Limitations (สำคัญ!)

**Free Tier บน Render มีข้อจำกัดกับ YouTube:**
- YouTube บล็อก IP ของ cloud provider (Render, AWS, etc.)
- วิดีโอที่มีข้อจำกัดอายุดาวน์โหลดไม่ได้เกือบทั้งหมด
- Error: "Sign in to confirm you're not a bot"

**ทางแก้ไข:**
1. **ใช้ Local** (แนะนำที่สุด) - Clone repo รันบนเครื่องตัวเอง
2. **ใช้ Proxy/VPN** - สำหรับ production (มีค่าใช้จ่าย)
3. **Self-Host** - รันบน Raspberry Pi/PC ที่บ้าน
4. **ลองวิดีโออื่น** - วิดีโอสาธารณะที่ไม่มีข้อจำกัด

ดูรายละเอียดเพิ่มเติมใน [YOUTUBE_LIMITATIONS.md](./YOUTUBE_LIMITATIONS.md)
...
- YouTube age-restricted: ดาวน์โหลดไม่ได้เพราะ cloud IP ถูกบล็อก
